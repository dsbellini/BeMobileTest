...
// Customer routes
router.post('/newcustomer', verifyToken, (req, res) => customerController.createCustomer(req, res));
router.get('/customers', verifyToken, (req, res) => customerController.findAllCustomers(req, res));
...
// Product routes
router.post('/newproduct', verifyToken, (req, res) => productController.createProduct(req, res));
router.get('/products', verifyToken, (req, res) => productController.findAllProducts(req, res));
...
// Sell routes
router.post('/newsell', verifyToken, (req, res) => sellController.createSell(req, res));

// Phone routes
router.post('/newphone', verifyToken, (req, res) => phoneController.createPhone(req, res));
router.get('/phones', verifyToken, (req, res) => phoneController.findAllPhones(req, res));
...
// Address routes
router.post('/newaddress', verifyToken, (req, res) => addressController.createAddress(req, res));
router.get('/addresses', verifyToken, (req, res) => addressController.findAllAddresses(req, res));
